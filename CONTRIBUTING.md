Contributing to Satoshi Coin
============================

The Satoshi Coin project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Satoshi Coin build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/satoshicoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to satoshicoin-qt
...
The following applies to code changes to the Satoshi Coin project (and related
projects such as libsecp256k1), and is not to be confused with overall Satoshi Coin
Network Protocol consensus changes.

Whether a pull request is merged into Satoshi Coin rests with the project merge
...
Patches that change Satoshi Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Satoshi Coin consensus, it must have been
...
The project leader is the release manager for each Satoshi Coin release.
