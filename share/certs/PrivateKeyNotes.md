...
unlocked to sign the SatoshiCoin-Qt.app bundle.
...
allowing somebody to distribute a SatoshiCoin-Qt.app or satoshicoin-qt-setup.exe with a valid
...
that the satoshicoin-qt.exe file inside the installer had not been tampered with.
