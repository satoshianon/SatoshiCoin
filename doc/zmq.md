...
The Satoshi Coin daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Satoshi Coin requires the ZeroMQ API >= 4.0.0
...
using. Satoshi Coind appends an up-counting sequence number to each
