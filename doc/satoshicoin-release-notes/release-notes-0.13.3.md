Satoshi Coin version 0.13.3 is now available from:

  <https://download.satoshicoin.pro/satoshicoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/satoshianon/SatoshiCoin/blob/0.13/src/chainparams.cpp#L214).
