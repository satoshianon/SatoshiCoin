# Support for Output Descriptors in Satoshi Coin

Since Satoshi Coin v0.17, there is support for Output Descriptors. This is a
...
existing Satoshi Coin wallets, a convenience function `combo` is
