...
These are the dependencies currently used by SatoshiCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/satoshicoinnl
Keybase  - https://keybase.io/team/satoshicoin/
