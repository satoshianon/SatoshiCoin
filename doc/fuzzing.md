# Fuzzing Satoshi Coin using libFuzzer

## Quickstart guide

To quickly get started fuzzing Satoshi Coin using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
[`process_message`](https://github.com/satoshianon/SatoshiCoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/satoshianon/SatoshiCoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/satoshianon/SatoshiCoin/tree/master/src/test/fuzz).
...
Every single pull request submitted against the Satoshi Coin repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Satoshi Coin more robust.
...
with certain assembly code from Satoshi Coin's code. See [developer notes on sanitizers](https://github.com/satoshianon/SatoshiCoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Satoshi Coin using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Satoshi Coin using [`afl-fuzz`](https://github.com/google/afl):
