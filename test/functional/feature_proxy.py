...
"""Test satoshicoind with different proxy configuration.

Test plan:
- Start satoshicoind's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on satoshicoind side:
...
class ProxyTest(BitcoinTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        if test_onion:
            addr = "bitcoinostk4e4re.onion:14742"
