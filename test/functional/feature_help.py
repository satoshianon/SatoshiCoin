...
"""Verify that starting satoshicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start satoshicoin with -h for help text")
        ...
        self.log.info("Start satoshicoin with -version for version information")
        ...
        self.log.info("Start satoshicoind with -fakearg to make sure it does not start")
