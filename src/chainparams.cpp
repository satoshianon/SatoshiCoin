...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 3 * 60; // 3 blocks
        consensus.nPowTargetSpacing = 1 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 8; // 75% of 12
        ...
        consensus.defaultAssumeValid = uint256S("0xd218809cf0e659301d1c4ffb01579f3568371794259f07a6127724d476749e59"); // 0
        ...
        vSeeds.emplace_back("162.0.237.24");
        vSeeds.emplace_back("162.255.117.32");
