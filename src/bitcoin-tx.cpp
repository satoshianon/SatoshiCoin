...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " satoshicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  satoshicoin-tx [options] <hex-tx> [commands]  Update hex-encoded satoshicoin transaction\n" +
            "or:     satoshicoin-tx [options] -create [commands]   Create hex-encoded satoshicoin transaction\n" +
            "\n";
