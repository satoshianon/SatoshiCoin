 ...
 * between satoshicoind, and satoshicoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/satoshianon/satoshicoin>";
    const std::string URL_WEBSITE = "<https://satoshicoin.pro/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Satoshi Coin Developers", 2023)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Satoshi Coin useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Satoshi Coin More version %s\n", FormatFullVersion());
}
