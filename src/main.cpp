...
#if defined(NDEBUG)
# error "Satoshi Coin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Satoshi Coin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // SatoshiCoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // SatoshiCoin also requires low S in sigs
