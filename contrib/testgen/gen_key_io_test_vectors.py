...
bech32_templates = [
  ...
  ('sat',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('sat',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('sat',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('sat',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tsat',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tsat',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tsat',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tsat',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tsat',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tsat',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tsat',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tsat',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rsat',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rsat',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rsat',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rsat', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tsat',   17, 32, Encoding.BECH32M, False, False, False),
  ('rsat',  3,  1, Encoding.BECH32M, False, False, False),
  ('sat',   15, 41, Encoding.BECH32M, False, False, False),
  ('tsat',    0, 16, Encoding.BECH32,  False, False, False),
  ('rsat',  0, 32, Encoding.BECH32,  True,  False, False),
  ('sat',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tsat',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rsat',  0, 20, Encoding.BECH32,  False, False, True),
  ('sat',    0, 20, Encoding.BECH32M, False, False, False),
  ('tsat',    0, 32, Encoding.BECH32M, False, False, False),
  ('rsat',  0, 20, Encoding.BECH32M, False, False, False),
  ('sat',    1, 32, Encoding.BECH32,  False, False, False),
  ('tsat',    2, 16, Encoding.BECH32,  False, False, False),
  ('rsat', 16, 20, Encoding.BECH32,  False, False, False),
]
